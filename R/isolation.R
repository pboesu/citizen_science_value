...
isolation <- function(df = ebd_wales, mindate = "2015-01-01", maxdate = "2015-12-31"){
...
iso_prio_2015 <- isolation(ebd_wales, mindate = "2015-01-01", maxdate = "2015-12-31") %>%
  mutate(year = 2015)
iso_prio_2016 <- isolation(ebd_wales, mindate = "2016-01-01", maxdate = "2016-12-31") %>%
  mutate(year = 2016)
iso_prio_2017 <- isolation(ebd_wales, mindate = "2017-01-01", maxdate = "2017-12-31") %>%
  mutate(year = 2017)
iso_prio_2018 <- isolation(ebd_wales, mindate = "2018-01-01", maxdate = "2018-12-31") %>%
  mutate(year = 2018)
